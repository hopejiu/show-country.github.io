...
This data package contains the data that powers the chart ["Energy use per person"](https://ourworldindata.org/grapher/per-capita-energy-use?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on May 19, 2026.
...
Source: U.S. Energy Information Administration (2026), Energy Institute - Statistical Review of World Energy (2025), Population based on various sources (2024) – with major processing by Our World In Data
