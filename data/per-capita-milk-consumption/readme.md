# Milk  supply per person - Data package

This data package contains the data that powers the chart ["Milk  supply per person"](https://ourworldindata.org/grapher/per-capita-milk-consumption?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on May 19, 2026.
...
## Yearly per capita supply of milk - excluding butter
