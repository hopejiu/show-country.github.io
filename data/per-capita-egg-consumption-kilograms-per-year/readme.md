# Per capita egg consumption - Data package

This data package contains the data that powers the chart ["Per capita egg consumption"](https://ourworldindata.org/grapher/per-capita-egg-consumption-kilograms-per-year?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on May 19, 2026.
...
## Yearly per capita supply of eggs
