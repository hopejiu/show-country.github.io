# Fruit consumption per capita - Data package

This data package contains the data that powers the chart ["Fruit consumption per capita"](https://ourworldindata.org/grapher/fruit-consumption-per-capita?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on May 19, 2026.
...
## Yearly per capita supply of fruit
